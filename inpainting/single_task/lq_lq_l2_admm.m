...
for iter = 1:MAX_ITER
   ...
   % z-update      
    b1 = x1 + w1/rho1;
    b2 = x2 + w2/rho2;
    %z1 = repmat(prox_Lq_m(b1, q1, rho1/mu/beta0),[1,L]) .* b1; % multitask
    %z2 = repmat(prox_Lq_m(b2, q2, rho2/beta0),[1,L]) .* b2;  % multitask
    z1 = [prox_Lq(b1(:,1), q1, rho1/mu/beta0), prox_Lq(b1(:,2), q1, rho1/mu/beta0), prox_Lq(b1(:,3), q1, rho1/mu/beta0)];% single-task
    z2 = [prox_Lq(b2(:,1), q2, rho2/beta0), prox_Lq(b2(:,2), q2, rho2/beta0), prox_Lq(b2(:,3), q2, rho2/beta0)];% single-task
